/**
 * SolidSecondary - Secondary色のソリッドボタン/リンク
 */
...
// Link版のプロパティ
interface SolidSecondaryLinkProps extends BaseProps {
  as: 'link'
  href: string
  disabled?: boolean
  target?: string
...
// Button版のプロパティ
interface SolidSecondaryButtonProps extends BaseProps {
  as: 'button'
...
type SolidSecondaryProps = SolidSecondaryLinkProps | SolidSecondaryButtonProps

const SolidSecondary: React.FC<SolidSecondaryProps> = (props) => {
  const {
    size = 'md',
    width,
    colorScheme = 'white',
  ...
  const styledClasses = getStyledClasses('solidSecondary', size, width, isDisabledOrLoading, colorScheme, className)
