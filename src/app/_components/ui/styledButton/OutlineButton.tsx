...
type OutlineProps = OutlineLinkProps | OutlineButtonProps
...
const Outline: React.FC<OutlineProps> = (props) => {
  ...
  const styledClasses = getStyledClasses('outline', size, width, isDisabledOrLoading, colorScheme, className)
