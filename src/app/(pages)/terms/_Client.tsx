...
// import { scrollTo, scrollToSelector } from '@/modules/screen'
import { commonAnimationObserver } from '@/app/_modules/ISObserver'
// コンポーネント
import SecondaryHeading from '@/app/_components/headings/SecondaryHeading'
// 型定義
// 定数
...
// import { Article } from '@/app/_components/models/creations/Types';
import useClientFetch from '@/app/_hooks/fetch/useClientFetch';
import { apiParamsObj } from '@/app/_modules/url';
...
export default function Client(props: Props) {
  ...
  // }
  // useEffect(() => {
  //   const apiParams: apiParamsObj = {
  //     path: "/top_articles",
  //     previewMode: false
  //   }
  //   // testFetch(composeApiUrl(apiParams))
  //   testFetch(composeApiUrl(apiParams))
  // }, []);
  ...
  return (
    <>
      <main id="p__terms" className="">
        {/* <h2>Terms</h2> */}

        <div className="terms_inner l__content_width_m">
          ...
          <section className="terms_section" id="">
            ...
            <div className="article_block">
              ...
              <p className="c__common_text_primary">当サイトでは、Googleによるアクセス解析ツール「Google アナリティクス」を利用しており、トラフィックデータ収集のためにCookieを使用しています。<br />
                ...
                この規約に関して、詳しくは「
                <HeadlessLink href="https://policies.google.com/technologies/partner-sites" target="_blank" rel="noopener noreferrer">こちら</HeadlessLink>
                」をご覧ください。</p>
            </div>
            ...
            <div className="article_block">
              ...
              <p className="c__common_text_primary">当サイトの記事について、著作権は放棄しておりません。<br />
                ...
                転載を希望される方は、「
                <HeadlessLink href={"/contact"} className="" >
                  お問い合わせ
                </HeadlessLink>
                」よりご連絡をお願いします。
              </p>
          ...
          <section className="terms_section" id="">
            <TertiaryHeading slash={false} level={2} id="privacy">プライバシーポリシー</TertiaryHeading>
